...
<form action="modificarExpediente2Controlador.php" method="post" enctype="multipart/form-data">
    ...
    <hr>
    <img src='../datos/imgpeques/<?php echo $exp->getFoto(); ?>'>
    ...
    <div class="materia">
        ...
        <textarea name="materias[0][comentario]"
            placeholder="Comentarios"><?php echo  $exp->getMaterias()[0]['comentario']?></textarea>
    </div>
    <div class="materia">
        <h2>Matematicas</h2>
        ...
        <textarea name="materias[1][comentario]"
            placeholder="Comentarios"><?php echo  $exp->getMaterias()[1]['comentario']?></textarea>
    </div>
    <div class="materia">
        <h2>Historia</h2>
        ...
        <textarea name="materias[2][comentario]"
            placeholder="Comentarios"><?php echo  $exp->getMaterias()[2]['comentario']?></textarea>
    </div>
