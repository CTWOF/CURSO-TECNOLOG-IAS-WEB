...
?>
	<form action="modificarExpediente2.php" method="post" enctype="multipart/form-data">
		...
		<div class="materia">
			<h2>Ciencias</h2>
			<input type="hidden" name="$exp->getMaterias()[nombre]" value="Ciencias">
			Nota: 
		...
		<div class="materia">
			...
			Comentarios:
			<textarea name="materias[1][comentario]" placeholder="Comentarios"><?php echo  $exp->getMaterias()[2]['comentario']?></textarea>
		</div>		
