...
<form action="modificarExpediente2.php" method="post" enctype="multipart/form-data">
    ...
    <input type="hidden" name='foto' value=<?php echo $expedientes[$id]['foto']; ?>>
    ...
    <hr>
    <img src='imgpeques/<?php echo $expedientes[$id]['foto']; ?>'>
    ...
    <div class="materia">
        ...
        Comentarios:
        <textarea name="materias[0][comentario]"
            placeholder="Comentarios"><?php echo  $expedientes[$id]['materias'][0]['comentario']?></textarea>
    </div>
    <div class="materia">
        <h2>Matematicas</h2>
        ...
        Comentarios:
        <textarea name="materias[1][comentario]"
            placeholder="Comentarios"><?php echo  $expedientes[$id]['materias'][1]['comentario']?></textarea>
    </div>
    <div class="materia">
        <h2>Historia</h2>
        ...
        Comentarios:
        <textarea name="materias[2][comentario]"
            placeholder="Comentarios"><?php echo  $expedientes[$id]['materias'][2]['comentario']?></textarea>
    </div>
