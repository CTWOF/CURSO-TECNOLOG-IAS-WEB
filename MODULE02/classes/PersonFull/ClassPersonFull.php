...
class Persona {
    ...
    function __destruct() {
        echo '<hr>';
        echo 'Eliminando el objeto:<br>' . $this->mostrarDatosFuncion();
    }
    ...
    function mostrarDatosFuncion() {
        return 'Datos de la persona:<br>' . $this->getNombre() . '<br>' . $this->getApe1() . '<br>' . $this->getApe2() . '<br>' . $this->getFechaNacimiento() . '<br>' . $this->getGenero() . '<br>';
    }
